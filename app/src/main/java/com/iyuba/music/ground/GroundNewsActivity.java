...
public class GroundNewsActivity extends BaseActivity implements MySwipeRefreshLayout.OnRefreshListener, IOnClickListener {
    ...
    private void getData() {
        ...
        if (curNewsType.equals(context.getString(R.string.voa_speical))) {
            getTitleUrl = "http://apps." + ConstantManager.IYUBA_CN + "voa/titleApi.jsp?maxid=0&pageNum=20&type=json&pages=" + curPage;
            downloadAppUrl += "com.iyuba.voa";
            lesson = "VOA慢速英语";
            app = "201";
        } else if (curNewsType.equals(context.getString(R.string.voa_cs))) {
            getTitleUrl = "http://apps." + ConstantManager.IYUBA_CN + "voa/titleApi.jsp?maxid=0&pageNum=20&category=csvoa&type=json&pages=" + curPage;
            ...
            getTitleUrl = "http://apps." + ConstantManager.IYUBA_CN + "minutes/titleApi.jsp?type=android&format=json&parentID=2&pageNum=20&maxid=0&pages=" + curPage;
            downloadAppUrl += "com.iyuba.bbcws";
            lesson = "BBC职场英语";
            app = "231";
        } else if (curNewsType.equals(context.getString(R.string.voa_bbc6))) {
            getTitleUrl = "http://apps." + ConstantManager.IYUBA_CN + "minutes/titleApi.jsp?type=android&format=json&parentID=1&pageNum=20&maxid=0&pages=" + curPage;
            downloadAppUrl += "com.iyuba.bbc";
            lesson = "BBC六分钟英语";
            app = "215";
        } else if (curNewsType.equals(context.getString(R.string.voa_ae))) {
            getTitleUrl = "http://apps." + ConstantManager.IYUBA_CN + "voa/titleApi.jsp?maxid=0&pageNum=20&type=json&parentID=200&pages=" + curPage;
            downloadAppUrl += "com.iyuba.AE";
            lesson = "美语怎么说";
            app = "213";
        } else if (curNewsType.equals(context.getString(R.string.voa_bbcnews))) {
            getTitleUrl = "http://apps." + ConstantManager.IYUBA_CN + "minutes/titleApi.jsp?type=android&format=json&parentID=3&pageNum=20&maxid=0&pages=" + curPage;
            downloadAppUrl += "com.iyuba.bbcinone";
            lesson = "BBC新闻";
            app = "221";
        } else if (curNewsType.equals(context.getString(R.string.voa_word))) {
            getTitleUrl = "http://apps." + ConstantManager.IYUBA_CN + "voa/titleApi.jsp?maxid=0&pageNum=20&type=json&parentID=10&pages=" + curPage;
            downloadAppUrl += "com.iyuba.WordStory";
            lesson = "VOA单词故事";
            app = "218";
        } else if (curNewsType.equals(context.getString(R.string.voa_ted))) {
            getTitleUrl = "http://apps." + ConstantManager.IYUBA_CN + "voa/titleTed2.jsp?maxid=0&pageNum=20&type=json&pages=" + curPage;
