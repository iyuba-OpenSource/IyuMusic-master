 ...
 */
public class MyPersonalHomeActivity extends BaseActivity implements MySwipeRefreshLayout.OnRefreshListener, View.OnClickListener {
...
//        //网络视频 需要开通网络访问权限
//        String uri = "http://video." + ConstantManager.IYUBA_CN + "minutes/" + "30690" + ".mp4";
...
//        changeUIResumeByPara();
    ...
    protected void initWidget() {
        ...
        doingAdapter.setItemClickListener(new OnRecycleViewItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                intent.putExtra(ReplyDoingActivity.VIP_FLG, userinfo.getVipStatus() != null && Integer.parseInt(userinfo.getVipStatus()) >= 1);
            ...
            public void onClick(View v) {
                if (SocialManager.getInstance().getFriendId().equals(AccountManager.getInstance().getUserId())) {
                    if (AccountManager.getInstance().checkUserLogin()) {
                        ...
                        CustomToast.getInstance().showToast("临时账号无法修改头像");
                    }
                } else {
                    Intent intent = new Intent(context, MeizhiPhotoActivity.class);
                    intent.putExtra("url", "http://api." + Constant.IYUBA_COM + "v2/api.iyuba?protocol=10005&size=big&uid=" + SocialManager.getInstance().getFriendId());
                    ...
                    , new IProtocolResponse() {
                        ...
                        public void response(Object object) {
                            ...
                            if (BaseApiEntity.isSuccess(baseApiEntity)) {
                                ...
                                doingAdapter.setVip(userinfo.getVipStatus() != null && Integer.parseInt(userinfo.getVipStatus()) >= 1);
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.toolbar_oper) {
            ...
            intent.putExtra("needpop", true);
            startActivity(intent);
        } else if (id == R.id.personal_other_detail || id == R.id.personal_detail) {
            Intent intent;
            SocialManager.getInstance().pushFriendId(userinfo.getUid());
            SocialManager.getInstance().pushFriendName(userinfo.getUsername());
            ...
            if (AccountManager.getInstance().checkUserLogin()) {
                ...
                CustomToast.getInstance().showToast("临时账号无法修改信息");
            }
        } else if (id == R.id.personal_credit) {
...
//                    }
    ...
    private void setContent() {
        ...
        personPhoto.setVipStateVisible(userinfo.getUid(), userinfo.getVipStatus() != null && Integer.parseInt(userinfo.getVipStatus()) >= 1);
    }
