...
public class OrderGenerateWeiXinRequest extends BaseJsonObjectRequest {
    ...
    private static final String URL = "http://vip." + ConstantManager.IYUBA_CN + "weixinPay.jsp?";

    private static String buildUrl(String productId,String wxkey, String appid, String uid, String money,
    ...
    public OrderGenerateWeiXinRequest(String productId, String wxkey, String appid, String uid, String money,
                                      String amount, String body, ErrorListener el, final RequestCallBack rc) {
        super(Method.POST, buildUrl(productId,wxkey, appid, uid, money, amount,body), el);
