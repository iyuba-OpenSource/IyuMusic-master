...
public class CampaignActivity extends BaseActivity {
    ...
    private String getRechargeUrl() {
        ...
        return "http://m." + ConstantManager.IYUBA_CN + "m_login/present.jsp?uid=" + userId + "&token=" + token;
    }

    private String getExchangeUrl() {
        return "http://m." + ConstantManager.IYUBA_CN + "mall/index.jsp?uid=" + AccountManager.getInstance().getUserId()
