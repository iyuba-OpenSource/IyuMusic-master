...
public class FavorSongActivity extends BaseActivity implements IOnClickListener {
    ...
    private void getYunFavor() {
        waittingDialog.show();
        Log.e("收藏列表url", FavorSynRequest.generateUrl(AccountManager.getInstance().getUserId()));
    ...
    private void getFavorDate() {
        FavorSynRequest.exeRequest(FavorSynRequest.generateUrl(songIds), new IProtocolResponse() {
            @Override
            public void onNetError(String msg) {
