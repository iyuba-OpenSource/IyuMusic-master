...
//        toolbarOper.setText(R.string.vip_iyubi_web);
    ...
    private void changeUIResumeByPara() {
        ...
        if ((userInfo != null) && userInfo.getVipStatus() != null && Integer.parseInt(userInfo.getVipStatus()) >= 1) {
    ...
    private void recharge() {
        ...
        intent.putExtra("url", "http://app." + ConstantManager.IYUBA_CN + "wap/index.jsp?uid="
