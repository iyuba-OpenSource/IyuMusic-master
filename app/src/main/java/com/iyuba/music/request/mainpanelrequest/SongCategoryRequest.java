...
public class SongCategoryRequest {
            ...
            MyJsonRequest request = new MyJsonRequest(
                ...
                public void onResponse(JSONObject jsonObject) {
                    try {
                        ...
                        ArrayList<SongCategory> list = new Gson().fromJson(jsonObject.getString("data"), listType);
                        if (list.size() == 0) {
    ...
    public static String generateUrl(int curPage) {
        String originalUrl = "http://apps." + ConstantManager.IYUBA_CN + "afterclass/getStyles.jsp";
