 ...
 */
public class RankListenRequest {
        ...
        if (NetWorkState.getInstance().isConnectByCondition(NetWorkState.ALL_NET)) {
                    ...
                    MyJsonRequest request = new MyJsonRequest(
                        ...
                        public void onResponse(JSONObject jsonRoot) {
                            ...
                            Log.e("获取数据","huoqush");
                            response.response(RankListenRequest.this);
    ...
    public static String generateUrl(String uid, String type, String start, String total, String mode) {
