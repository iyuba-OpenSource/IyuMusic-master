...
public class DoingCommentRequest {
                    ...
                    try {
                        ...
                        if ("311".equals(resultCode)) {
                            ...
                            if (jsonObject.getInt("counts") == 0) {
                                ...
                                Type listType = new TypeToken<ArrayList<DoingComment>>() {
                                }.getType();
                                ArrayList<DoingComment> list = new Gson().fromJson(jsonObject.getString("data"), listType);
    ...
    public static String generateUrl(String id, int page) {
