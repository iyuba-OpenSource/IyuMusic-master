...
public class AdPicRequest {
                    ...
                    try {
                        ...
                        switch (type) {
                            ...
                            case "web":
                                ...
                                adEntity.setPicUrl("http://app." + ConstantManager.IYUBA_CN + "dev/" + adEntity.getPicUrl());
                                adEntity.setType("web");
                                break;
                            case "ads2":
                                adEntity.setType("ads2");
                            case "ads5":
                                adEntity = new Gson().fromJson(jsonObject.getString("data"), AdEntity.class);
                                adEntity.setPicUrl("http://app." + ConstantManager.IYUBA_CN + "dev/" + adEntity.getPicUrl());
                                adEntity.setType("ads5");
                        }
    ...
    public static String generateUrl() {
        String originalUrl = "http://app." + ConstantManager.IYUBA_CN + "dev/getAdEntryAll.jsp";
