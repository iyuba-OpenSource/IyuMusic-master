...
//                                article.setMusicUrl("http://video." + ConstantManager.IYUBA_CN + "voa/" + article.getId() + ".mp4");
                                article.setMusicUrl(ConstantManager.videoPrefix + jsonObjectData.getString("video"));
    ...
    public static String generateUrl(int page) {
        String originalUrl = "http://apps." + ConstantManager.IYUBA_CN + "iyuba/titleTed.jsp";
