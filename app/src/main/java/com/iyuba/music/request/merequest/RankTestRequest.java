...
public class RankTestRequest {
        ...
        if (NetWorkState.getInstance().isConnectByCondition(NetWorkState.ALL_NET)) {
                    ...
                    MyJsonRequest request = new MyJsonRequest(
                        ...
                        public void onResponse(JSONObject jsonRoot) {
                            ...
                            Log.e("获取数据","huoqush");
                            response.response(RankTestRequest.this);
    ...
    public static String generateUrl(String uid, String type, String start, String total) {
        ...
        String originalUrl = "http://daxue." + ConstantManager.IYUBA_CN + "ecollege/getTestRanking.jsp";
