...
public class LrcRequest {
            ...
            MyJsonRequest request = new MyJsonRequest(
                ...
                public void onResponse(JSONObject jsonObject) {
                    ...
                    try {
                        ...
                        ArrayList<Original> list = null;
                        if (jsonObject.has("data")) {
                            list = new Gson().fromJson(jsonObject.getString("data"), listType);
                        }
                        if (jsonObject.has("textInfo")) {
                            list = new Gson().fromJson(jsonObject.getString("textInfo"), listType);
                        }
    ...
    public static String generateUrl(int id, int type) {
        ...
        switch (type) {
            case 0:
                paras.put("voaid", id);
                String voaOriginalUrl = "http://apps." + ConstantManager.IYUBA_CN + "voa/textNewApi.jsp";
                url = ParameterUrl.setRequestParameter(voaOriginalUrl, paras);
                break;
            case 1:
                paras.put("bbcid", id);
                String bbcOriginalUrl = "http://apps." + ConstantManager.IYUBA_CN + "minutes/textApi.jsp";
                url = ParameterUrl.setRequestParameter(bbcOriginalUrl, paras);
                break;
            case 2:
                paras.put("SongId", id);
                String musicOriginalUrl = "http://apps." + ConstantManager.IYUBA_CN + "afterclass/getLyrics.jsp";
                url = ParameterUrl.setRequestParameter(musicOriginalUrl, paras);
                break;
            case 3:
                paras.put("titleid", id);
                String olympicOriginalUrl = "http://apps." + ConstantManager.IYUBA_CN + "afterclass/getItemText.jsp";
                url = ParameterUrl.setRequestParameter(olympicOriginalUrl, paras);
                break;
            default:
                url = "";
                break;
