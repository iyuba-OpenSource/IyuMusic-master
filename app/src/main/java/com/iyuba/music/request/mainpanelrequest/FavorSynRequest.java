...
public class FavorSynRequest {
    ...
    public static String generateUrl(String userid) {
        String originalUrl = "http://apps." + ConstantManager.IYUBA_CN + "afterclass/getCollect.jsp";
...
//        String originalUrl = "http://apps." + ConstantManager.IYUBA_CN + "afterclass/getSongList.jsp";
