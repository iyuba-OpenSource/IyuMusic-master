    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        ...
        switch (circle.getIdtype()) {
            ...
            case "picid":
                ...
                ImageUtil.loadImage("http://static1." + ConstantManager.IYUBA_CN + "data/attachment/album/" + getSmallImageUrl(circle.getImage())
                ...
                holder.circleImg.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        intent.putExtra("url", "http://static1." + ConstantManager.IYUBA_CN + "data/attachment/album/" + circle.getImage());
        ...
        holder.circlePhoto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                context.startActivity(PersonalHomeActivity.buildIntent(context, Integer.parseInt(circle.getUid()), "", 0));
