    ...
    public void onBindViewHolder(RecycleViewHolder holder, int position) {
        ...
        if (holder instanceof NewsViewHolder) {
            ...
            if (onRecycleViewItemClickListener != null) {
                MaterialRippleLayout rippleView =  newsViewHolder.rootview;
                rippleView.setOnClickListener(v -> onRecycleViewItemClickListener.onItemClick(newsViewHolder.itemView, pos));
            }
            ...
            ImageUtil.loadImage("http://staticvip." + ConstantManager.IYUBA_CN + "images/song/" + songCategory.getImgUrl(),
