...
import com.iyuba.music.activity.me.MyPersonalHomeActivity;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.userImageView.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                context.startActivity(PersonalHomeActivity.buildIntent(context, Integer.parseInt(message.getAuthorid()), "", 0));
