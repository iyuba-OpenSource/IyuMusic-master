...
import com.iyuba.music.util.BitmapUtil;
...
public class CircularImageView extends ImageView {
    ...
    private void setCustomAttributes(AttributeSet attrs) {
        ...
        mBorderThickness = a.getDimensionPixelSize(  
                R.styleable.CircularImageView_border_thick, 0);
        mBorderOutsideColor =
                a.getColor(R.styleable.CircularImageView_border_out_color,
                        defaultColor);  
        mBorderInsideColor = a.getColor(  
                R.styleable.CircularImageView_border_in_color, defaultColor);
        a.recycle();
    }  
