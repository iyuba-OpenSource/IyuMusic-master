...
public abstract class BaseVideoControl extends VideoControls {
    ...
    public BaseVideoControl(Context context) {
        super(context);
        playDrawable = ResourcesCompat.getDrawable(context.getResources(), R.drawable.ic_play, context.getTheme());
        pauseDrawable = ResourcesCompat.getDrawable(context.getResources(), R.drawable.ic_pause_talk, context.getTheme());
    }
