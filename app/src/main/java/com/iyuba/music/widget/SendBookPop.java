...
import com.iyuba.music.activity.SendBookActivity;
...
//        this.setAnimationStyle(R.style.AnimationPreview);
        ...
        ForegroundColorSpan colorSpan = new ForegroundColorSpan(context.getResources().getColor(R.color.skin_app_color_light_red));
        spanText.setSpan(colorSpan, 46, 49, Spanned.SPAN_EXCLUSIVE_INCLUSIVE);
        ForegroundColorSpan colorSpan2 = new ForegroundColorSpan(context.getResources().getColor(R.color.skin_app_color_light_red));
        spanText.setSpan(colorSpan2, 50, 54, Spanned.SPAN_EXCLUSIVE_INCLUSIVE);
        ForegroundColorSpan colorSpan3 = new ForegroundColorSpan(context.getResources().getColor(R.color.skin_app_color_light_red));
        spanText.setSpan(colorSpan3, 65, 78, Spanned.SPAN_EXCLUSIVE_INCLUSIVE);
        ForegroundColorSpan colorSpan4 = new ForegroundColorSpan(context.getResources().getColor(R.color.skin_app_color_light_red));
        ...
        spanText.setSpan(new ClickableSpan() {
            ...
            public void updateDrawState(TextPaint ds) {
                ...
                ds.setColor(context.getResources().getColor(R.color.skin_app_color));       //设置文件颜色
                ds.setUnderlineText(true);      //设置下划线
            }

            @Override
            public void onClick(View view) {
                Intent intent = ChattingActivity.buildIntent(context, 915340, 0, AccountManager.getInstance().getUserName(), "", "two");
