...
-keep class com.iyuba.music.entity.** {*;}
#mob sms
...
#旺脉广告混淆
-keep class com.wangmai.wangmai_allmobads_sdk.wm.bean.** { *; }
-keep class com.wangmai.wangmai_allmobads_sdk.bean.** { *; }
-keep class com.wangmai.wangmai_allmobads_sdk.**{*;}
...
-keep class com.iyuba.imooclib.data.model.**{*;}

-libraryjars libs/youdaosdk_xxx.aar
-keep class com.youdao.sdk.* { *;}
-libraryjars libs/miit_mdid_1.0.13.aar
